...
// return numPill > 1 ? (numPill-1) * ist * 100 + (numPill-2) * width : 0

console.log(pillars(1, 10, 10))//Salida 0
console.log(pillars(2, 20, 25))//Salida 2000
console.log(pillars(11, 15, 30))//Salida 15270